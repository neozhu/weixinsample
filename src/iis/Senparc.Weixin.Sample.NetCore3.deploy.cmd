...
set _DeploySetParametersFile=%RootPath%Senparc.Weixin.Sample.NetCore3.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%Senparc.Weixin.Sample.NetCore3.zip" (
echo "%RootPath%Senparc.Weixin.Sample.NetCore3.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Senparc.Weixin.Sample.NetCore3.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%Senparc.Weixin.Sample.NetCore3.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%Senparc.Weixin.Sample.NetCore3.deploy-readme.txt" (
...
start notepad "%RootPath%Senparc.Weixin.Sample.NetCore3.deploy-readme.txt"
)
echo =========================================================
goto :eof
